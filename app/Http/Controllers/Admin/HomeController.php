...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'Total COD 1 Bulan',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\DetailTransaksi',
            ...
            'entries_number'        => '5',
            'translation_key'       => 'detailTransaksi',
        ];
