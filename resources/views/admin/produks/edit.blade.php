    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.produks.update", [$produk->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_produk') ? 'is-invalid' : '' }}" type="text" name="kode_produk" id="kode_produk" value="{{ old('kode_produk', $produk->kode_produk) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('deskripsi') ? 'is-invalid' : '' }}" name="deskripsi" id="deskripsi">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
